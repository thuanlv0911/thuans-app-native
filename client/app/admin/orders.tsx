                ...
                <FlatList
                    ...
                    renderItem={({ item }) => (
                        <TouchableOpacity
                            ...
                            className={`mr-2 px-4 py-2 rounded-full flex-row items-center ${activeFilter === item ? 'bg-primary' : 'bg-white'
                                }`}
                        >
                            <Text className={`text-sm font-medium capitalize ${activeFilter === item ? 'text-white' : 'text-secondary'
                                }`}>
                                {item}
                            </Text>
                            <View className={`ml-2 px-1.5 py-0.5 rounded-full ${activeFilter === item ? 'bg-white/20' : 'bg-gray-100'
                                }`}>
                                <Text className={`text-xs font-bold ${activeFilter === item ? 'text-white' : 'text-secondary'
                                    }`}>
                                                    ...
                                                    <View className="mb-5">
                                                        ...
                                                        {selectedOrder.items.map((item, index) => (
                                                            <View
                                                                ...
                                                                className={`flex-row justify-between py-3 ${index !== selectedOrder.items.length - 1 ? 'border-b border-gray-100' : ''
                                                                    }`}
                                                            >
                                                                <View className="flex-1">
                                        ...
                                        {availableStatuses.map((status) => {
                                            ...
                                            return (
                                                <TouchableOpacity
                                                    ...
                                                    className={`flex-row items-center p-4 rounded-xl mb-2 ${isActive ? 'bg-primary/10 border-2 border-primary' : 'bg-gray-50'
                                                        }`}
                                                >
                                                    <View
                                                        className="w-10 h-10 rounded-full items-center justify-center mr-3"
                                                    ...
                                                    <Text className={`flex-1 font-medium capitalize ${isActive ? 'text-primary font-bold' : 'text-secondary'
                                                        }`}>
                                                        {status}
                                                    </Text>
                                                    {isActive && (
